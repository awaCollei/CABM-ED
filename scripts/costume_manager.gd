...
func initialize(character_node):
	"""初始化管理器"""
...
func open_costume_selector():
	"""打开换装选择器"""
	var costume_selector_scene = load("res://scenes/ui/costume_selector.tscn")
	var costume_selector = costume_selector_scene.instantiate()
...
func _on_costume_selected(costume_id: String):
	...
	MessageDisplay.show_info_message("服装已更换")
