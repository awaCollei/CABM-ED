...
@export var output_filename: String = "input.png"
@export var flip_vertically: bool = false  # 新增：控制是否垂直翻转
@export var flip_horizontally: bool = false  # 新增：控制是否水平翻转
...
func get_tilemap_bounds(tilemap_layer: TileMapLayer) -> Rect2:
	...
	var tile_size = Vector2(32, 32)  # 瓦片大小为32x32
